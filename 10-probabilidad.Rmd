...
Consideremos un experimento compuesto consistiendo en dos subexperimentos, experimento $A$ y experimento $B$. supongamos que el experimiento $A$ tiene $a$ posibles resultados y para cada uno de esos resultados el experimento $B$ tiene $b$ posibles resultados, entonces el experimento compuesto tiene $ab$ posibles resultados
:::
